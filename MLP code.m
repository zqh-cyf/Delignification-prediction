clc;clear;close all;	
load('R_14_Oct_2024_11_22_48.mat')	
...
t1=clock; 	
 hidden_size=G_out_data.hidden_size1;    %神经网络隐藏层	
  ...
  [Mdl,fitness] = optimize_fitrMLP(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti);    	
